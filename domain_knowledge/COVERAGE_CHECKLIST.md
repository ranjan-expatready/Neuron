...
### 1.7 Documents
- Status: 🟡
- Raw: `domain_knowledge/raw/documents/sources.md`
- Processed: `domain_knowledge/processed/documents/overview.md`
- Covered: EE profile vs e-APR doc expectations (language test, ECA, PoF, police, medical, job offer, PNP).
- Missing / TODO: Per-program checklist granularity; validity windows (police/medical); ADR patterns.

### 1.8 Biometrics & Medicals
- Status: 🟡
- Raw: `domain_knowledge/raw/biometrics_medicals/sources.md`
- Processed: `domain_knowledge/processed/biometrics_medicals/overview.md`
- Covered: Biometrics age scope (14–79), fee timing, 30-day deadline after letter; medicals feed admissibility; incomplete apps can be rejected/refunded.
- Missing / TODO: Medical validity duration; panel physician requirements; reuse rules; fee/waiver edge cases.

### 1.9 Express Entry Program Family
- Status: 🟡
- Raw: `domain_knowledge/raw/express_entry/sources.md`
- Processed: `domain_knowledge/processed/program_families/express_entry.md`
- Covered: FSW/CEC/FST contrasts; PNP +600; job-offer points removed; high-level post-ITA steps (biometrics, medical/police).
- Missing / TODO: FSW 67-point grid detail; FST qualifying trades list; draw types/category-based selection references.
