...
- ✅ Dev-mode change (2025-12-13 UTC) — Ruleset `11070317` (integration/**) approvals temporarily set 1→0 to speed integration; required status check `all` remained required. To be reverted before production release.
