...
- **Description:** Implement CRS scoring per current IRCC rules with unit/integration tests `[BP-03 §CRS]`. Config-first engine shipped backend-only; M5.2/M5.3 will add explanations + full case/API wiring.
