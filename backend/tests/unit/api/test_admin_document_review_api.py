...
def _add_document(db_session, org_id: str, case_id: str, document_type: str, filename: str, mime="application/pdf") -> Document:
    doc = Document(
        org_id=org_id,
        case_id=case_id,
...
def test_document_review_api_success(client: TestClient, admin_headers):
    ...
    _add_document(client.db_session, org_id, case.id, "passport", "passport.pdf", mime="text/plain")
