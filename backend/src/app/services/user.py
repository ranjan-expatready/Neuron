...
class UserService:
    ...
    def create_user(db: Session, user_data: UserRegister) -> User:
        ...
        # Create user - password hashing uses bcrypt directly (no passlib)
        # This avoids any wrap bug detection issues
        ...
        if user_data.organization_name:
            org = Organization(name=user_data.organization_name, type="law_firm")
            db.add(org)
